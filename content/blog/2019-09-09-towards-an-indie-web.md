...
Next we need our userID, to get them, we are not going to parse anything, we will use some third party web, because the ones i found are dead simple, you put your username and they give you the id. The ones i found that work are: [https://gettwitterid.com/](https://gettwitterid.com/) and [https://tweeterid.com/](https://tweeterid.com/)
